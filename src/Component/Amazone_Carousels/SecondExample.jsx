  ...
  return (
   <> 
    <div style={{display:"flex" ,flexWrap:"wrap", justifyContent:"center",marginTop:"50px", position:"relative"}}>
     ...
     <div style={{display:"flex",justifyContent:"center",gap:"10px",margin:"20px 0px"}}>
        {
            [1,2,3,4,5,6,7].map((dot ,i ) =>(               
                <div className={photo === i ? "common active" : "common"}></div>
     ...
     <div style={{display:"flex",justifyContent:"center",gap:"10px"}}>
        {
            [1,2,3,4,5,6].map((e , i) =>(<RxDotFilled /> ))
        }
     </div>
     

    <div>
        <button style={{width:"150px", backgroundColor:"deeppink", marginTop:"10px"}}  onClick={() => {setPhoto(photo + 1)}} disabled={photo===6 || photo=== -1}>{photo}</button>
    </div>
    <p>Here you can loop through the image</p>
